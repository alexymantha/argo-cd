...
var (
	...
	ApplicationSetSyncStrategySchemaGroupVersionKind        = schema.GroupVersionKind{Group: application.Group, Version: "v1alpha1", Kind: application.ApplicationSetSyncStrategyKind}
	ClusterApplicationSetSyncStrategySchemaGroupVersionKind = schema.GroupVersionKind{Group: application.Group, Version: "v1alpha1", Kind: application.ClusterApplicationSetSyncStrategyKind}
)
...
func addKnownTypes(scheme *runtime.Scheme) error {
	scheme.AddKnownTypes(SchemeGroupVersion,
		...
		&ApplicationSet{},
		&ApplicationSetList{},
		&ApplicationSetSyncStrategy{},
		&ApplicationSetSyncStrategyList{},
		&ClusterApplicationSetSyncStrategy{},
		&ClusterApplicationSetSyncStrategyList{},
	)
